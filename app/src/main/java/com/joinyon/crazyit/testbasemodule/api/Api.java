...
import com.joinyon.basemodule.utils.NetWorkUtils;
import com.joinyon.crazyit.testbasemodule.utils.SPHelper;
    ...
    private Api(int hostType) {
        ...
        HttpLoggingInterceptor logInterceptor = new HttpLoggingInterceptor(new HttpLoggingInterceptor.Logger() {
            ...
            public void log(String message) {
                Log.e("XUSANGBO_OkHttpClient", "OkHttpMessage:" + message);
            }
        });
        ...
        Interceptor headerInterceptor = new Interceptor() {
            ...
            public Response intercept(Chain chain) throws IOException {
                Request build = chain.request().newBuilder()
                        ...
                        .addHeader("token", SPHelper.getToken())
                        .addHeader("id", SPHelper.getUserId())
                        .build();
